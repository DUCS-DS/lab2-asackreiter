[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=17973705)
# Sp25Lab2
...
* the big-O worst-case complexity of the function **search** is O(N).
  ```python
  def search(lst, key):
...
I would use the function **search** (defined above) in real life because the worst-case run time is not that bad and the best-case is optimal.
